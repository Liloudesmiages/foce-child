        ...
        <nav id="site-navigation" class="main-navigation">
            ...
            <div id="menu-content" class="menu-content">
                <div class="menu-liens">
                    <a href="#hero-header"><img class="logo-header2" src="<?php echo get_stylesheet_directory_uri() . '/assets/images/logomenu.png'; ?>" alt="Logo Fleurs d'oranger & chats errants" /></a>
